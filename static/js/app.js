		...
		<div class="pokemon-card">
		  ...
		  <div class="card_back">
			...
			style="background: linear-gradient(to right, ${
										  ...
										  } ${(el.stats[0].base_stat/255)*100}%, ${colors[pokemonTypes[0]]}71 
			${(el.stats[0].base_stat/255)*100}%"
			>
			</div>
			...
			style="background: linear-gradient(to right, ${
											  colors[pokemonTypes[0]]
										  } ${(el.stats[1].base_stat/255)*100}%, ${colors[pokemonTypes[0]]}71 
			${(el.stats[1].base_stat/255)*100}%"
			>
			</div>
			...
			style="background: linear-gradient(to right, ${
											  colors[pokemonTypes[0]]
										  } ${(el.stats[2].base_stat/255)*100}%, ${colors[pokemonTypes[0]]}71 
			${(el.stats[2].base_stat/255)*100}%"
			>
			</div>
			...
			style="background: linear-gradient(to right, ${
											  colors[pokemonTypes[0]]
										  } ${(el.stats[3].base_stat/255)*100}%, ${colors[pokemonTypes[0]]}71 
			${(el.stats[3].base_stat/255)*100}%"
			>
			</div>
			...
			style="background: linear-gradient(to right, ${
											  colors[pokemonTypes[0]]
										  } ${(el.stats[4].base_stat/255)*100}%, ${colors[pokemonTypes[0]]}71 
			${(el.stats[4].base_stat/255)*100}%"
			>
			</div>
			...
			style="background: linear-gradient(to right, ${
											  colors[pokemonTypes[0]]
										  } ${(el.stats[5].base_stat/255)*100}%, ${colors[pokemonTypes[0]]}71 
			${(el.stats[5].base_stat/255)*100}%"
			>
			</div>
			<div class="poke-stats-name">Generation: ${currentGen+1}</div>
		  </div>
		</div>
	  </div>
		`;
...
buttons.forEach((el) => {
	el.addEventListener("click", (e) => {
		...
		if (
			...
			heading.innerText = generations[currentGen][0] + "";
